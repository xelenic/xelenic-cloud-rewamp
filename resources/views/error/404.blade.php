...
@section('content')
    ...
    <div style="margin-top: 70px;box-sizing: content-box !important;margin-bottom: 131px;">
        <nav class="shelf" style="box-sizing: content-box;">
        ...
        <h3 style="text-align: -webkit-center;">404: Page Not Found... But Our Sense of Humor Is Still Intact!</h3>
        <br>
        <div style="text-align: -webkit-center;">
            <p style="color:#fff0ff;width: 640px;">Whoops-a-daisy! Looks like you've stumbled into the digital wilderness. Fear not, brave explorer, for we have a few tricks up our sleeves to rescue you from this pixelated abyss:</p>
        </div>
