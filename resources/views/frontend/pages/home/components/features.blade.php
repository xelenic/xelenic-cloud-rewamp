...
">
                                <div class="bg-dark text-white rounded text-center p-3" style="
...
">Years of experience</p>
                            ...
                            <div class="col-sm-6">
                                <div class="bg-primary rounded text-center p-3">
                                    ...
                                    <p class="mb-0 text-white">Happy customers Expirince</p>
                                </div>
                            </div>
                        </div>
...
">Embrace a new era of digital success with Mizzle. Our team combines cutting-edge design with robust development to deliver websites that captivate and convert.</p>
                <!-- List -->
                <ul class="list-group list-group-borderless mb-4" style="
    font-size: 19px;
">
                    <li class="list-group-item heading-color d-flex mb-0" style="
"><i class="bi bi-patch-check-fill text-primary me-2"></i>Emphasis on ROI-driven solutions</li>
