            ...
            <div class="col-lg-3 col-md-6">
                ...
                <section class="widget widget-light-skin">
                    ...
                    <ul class="list-unstyled text-sm text-white">
                        <li><span class="opacity-50" style="
    padding-left: 0px;
">Monday-Friday:</span>9.00 am - 8.00 pm</li>
            ...
            <div class="col-lg-3 col-md-6">
                <!-- Mobile App Buttons-->
                <section class="widget widget-light-skin">
                    <h3 class="widget-title">Our Mobile App</h3><a class="market-button windows-button mb-light-skin" href="#"><span class="mb-subtitle">Download on the</span><span class="mb-title">Windows Store</span></a>
                </section>
            </div>
            <div class="col-lg-3 col-md-6">
                <!-- About Us-->
...
">
        ...
        <!-- Copyright-->
        <p class="footer-copyright"><a>© All rights reserved.</a></p>
    </div>
</footer>
