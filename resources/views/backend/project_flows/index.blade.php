...
<body>
<script src="{{url('workkflows/dist/drawflow.min.js')}}"></script>
<link rel="stylesheet" type="text/css" href="{{url('workkflows/src/drawflow.css')}}" />
<link rel="stylesheet" type="text/css" href="{{url('workkflows/beautiful.css')}}" />
...
<div class="row">
    <div class="col-md-2">
        @include('backend.project_flows.components.tools_box')
    </div>
    <div class="col-md-10">
        <div class="menu">
            <ul>
  ...
  */
    ...
    */
    ...
    function addNodeToDrawFlow(name, pos_x, pos_y) {
        ...
        switch (name) {
            @stack('blueprint_nodes')

            case 'slack':
                var slackchat = `<div><div class="title-box"><i class="fab fa-slack"></i> Slack chat message</div></div>`
